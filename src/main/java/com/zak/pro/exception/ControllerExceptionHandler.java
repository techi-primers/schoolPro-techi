...
import com.zak.pro.dto.ExceptionDTO;
...
public class ControllerExceptionHandler {
	...
	public ExceptionDTO customExceptionHandler(CustomException customException) {
		ControllerExceptionHandler.LOG.error("unxpected error has happend " + customException.getMessage());
		ExceptionDTO exceptionDTO = this.initExceptionDTO(customException, customException.getMessage(), 400,
				"Bad Request");
		return exceptionDTO;
	}
